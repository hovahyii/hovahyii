  ...
  return (
    <div className={`lg:block lg:w-1/3 overflow-y-auto ${isDarkMode ? 'dark' : ''}`}>
      <div className="mt-12 flex flex-col items-center md:items-start text-center md:text-left">
        ...
        <h1 className={`mt-4 text-4xl font-bold ${isDarkMode ? 'text-white' : 'text-black'}`}>Jehovah Yii Zui Hon</h1>
        ...
        <div className="mt-2 flex items-center">
          ...
          <span className={`ml-1 text-sm md:text-lg ${isDarkMode ? 'text-white' : 'text-black'}`}>Selangor, Malaysia</span>
          <SiHuawei className="ml-2 md:ml-4 text-red-500" size="1.2em" />
          <span className={`ml-1 text-sm md:text-lg ${isDarkMode ? 'text-white' : 'text-black'}`}>RF Engineer Intern</span>
        </div>
        <p className={`mt-4 text-xl font-semibold ${isDarkMode ? 'text-white' : 'text-black'}`}>Student, Mentor, Developer</p>
        ...
        <div className="mt-4 flex w-full max-w-xs flex-col sm:flex-row sm:space-x-4">
          ...
          />
          <Button className={`mt-2 sm:mt-0 ${isDarkMode ? 'bg-red-600 text-white hover:bg-gray-500 hover:text-white' : 'bg-red-600 text-white'}`}>
